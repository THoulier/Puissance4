...
public class Game{
    ...
    void runGame(){
        ...
        while (tabPlayers[1].getWin() < 2 && tabPlayers[2].getWin() < 2 && exit != 1) {
            //writeLogText("Round begins\n");
            writeLogText("Manche commence\n");
            ...
            while (tour < ((grid.getNbline() * grid.getNbcol()) + offset)) {
                ...
                if (grid.colValidity(col, playerNb) == true) {
                    ...
                    writeLogText("Joueur " + tabPlayers[playerNb].getNb()+" joue " + (col+1) +"\n");
                    ...
                    if (line != -1) {
                        ...
                        if (grid.isWinning(col, line, tour) == true) {
                            ...
                            writeLogText("Joueur "+ playerNb + " gagne\n");
